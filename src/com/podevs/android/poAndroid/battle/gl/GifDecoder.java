...
public class GifDecoder {
    ...
    public SpriteAnimation getAnimation(Animation.PlayMode playType) {
        ...
        SpriteAnimation result = new SpriteAnimation(frameDuration, texReg, playType);

        return result;
    }

    public static SpriteAnimation loadGIFAnimation(Animation.PlayMode playType, InputStream is) {
